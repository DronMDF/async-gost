...
void CryptoEngineAVX2::set_sbox(const uint8_t sbox[64])
{
...
void CryptoEngineAVX2::set_key(int slot, const void *source_key)
{
	assert(slot < 4);
	for (int i = 0; i < 8; i++) {
